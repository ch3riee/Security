...
#### ADDING YOUR WEB MICROSERVICE TO NGINX
Locate the map block inside of the Nginx configuration file.
```
map $uri $public_services {
    default   http://srvjavausers:8081;

    # Add your public microservice URL regex and server location map entry here: ###

    ~^/rest/public/sample/.*   http://srv-sample:8000;
    ~^/rest/public/sample2/.*   http://srv-sample:8000;
    ~^/rest/public/sample3/.*   http://srv-sample:8000;
    # ...
