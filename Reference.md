...
http://127.0.0.1:8080/rest/public/gateway/service/read?sname=_____ </br>
...
Example POST endpoint:
http://127.0.0.1:8080/rest/public/gateway/service/update?sname=_____ </br>
...
EXAMPLE GET endpoint:
http://127.0.0.1:8080/rest/public/gateway/service/delete?sname=_____ </br>
...
#### 2. READ USER ACCOUNT
EXAMPLE GET endpoint:
http://127.0.0.1:8080/rest/public/gateway/user/read?uname=_____ </br>
...
EXAMPLE POST endpoint:
http://127.0.0.1:8080/rest/public/gateway/user/update?uname=_____ </br>
...
EXAMPLE GET endpoint:
http://127.0.0.1:8080/rest/public/gateway/user/delete?uname=_____ </br>
...
#### 1. CREATE ROLE
http://127.0.0.1:8080/rest/public/gateway/role/create?rname=_______ </br>
...
#### 4. UPDATE ROLE
http://127.0.0.1:8080/rest/public/gateway/role/update?rname=_______ </br>
